...
/* Global variables */
extern  uint16  resultx, resulty, resultz;

extern void MMA8451_Standby(void);
extern void MMA8451_Active(void);
extern void MMA8451WriteRegister(uint8 address, uint8 reg,uint8 val);
extern uint8 u8MMA8451ReadRegister(uint8 address, uint8 reg);
extern void MMA8451WriteRegister_N(uint8 address, uint8 reg1,uint8 N,uint8 *array);
extern void MMA8451ReadRegister_N(uint8 address, uint8 reg1,uint8 N,uint8 *array);
