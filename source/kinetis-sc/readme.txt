...
Currently all projects use the IAR toolchain. Support for additional toolchains will be added in the future.
...
The kinetis-sc\build\iar folder contains a "make_new_project.exe" file. This script
can be used to clone the hello_world project . The script will prompt you for a name
to use for the new project, then creates copies of all needed files and folders.
