///////////////////////////////////////////////////////////////////////////////
//                                                                            /
// IAR ANSI C/C++ Compiler V6.10.1.52143/W32 for ARM    17/Feb/2011  21:31:21 /
// Copyright 1999-2010 IAR Systems AB.                                        /
//                                                                            /
//    Cpu mode     =  thumb                                                   /
//    Endian       =  little                                                  /
//    Source file  =  D:\Profiles\B17685\My Documents\FAE\MCU\Kinetis\ƒ‚[ƒ^ /
//                    [\kinetis-sc\src\cpu\sysinit.c                          /
//    Command line =  "D:\Profiles\B17685\My Documents\FAE\MCU\Kinetis\ƒ‚[ƒ^ /
//                    [\kinetis-sc\src\cpu\sysinit.c" -D IAR -D TWR_K40X256  /
...
//                    [\kinetis-sc\build\iar\pit_dma\RAM_128KB\List\sysinit.s /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////
...
// D:\Profiles\B17685\My Documents\FAE\MCU\Kinetis\ƒ‚[ƒ^[\kinetis-sc\src\cpu\sysinit.c
//    1 /*
//    2  * File:        sysinit.c
...
//  112   	    uart_init (TERM_PORT, periph_clk_khz, TERMINAL_BAUD);
        ...
        LDR      R1,[R0, #+0]
        LDR.N    R0,??DataTable2_7  ;; 0x4006d000
        BL       uart_init
//  113 }
        POP      {R0,PC}          ;; return
//  114 /********************************************************************/
