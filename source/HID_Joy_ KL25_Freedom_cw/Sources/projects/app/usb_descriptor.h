 ...
 * @date Oct-8-2012
 *
 * @brief The file is a header file for USB Descriptors required for HID joystick
 *        Application
 *****************************************************************************/
...
#define JOY_IFC_INDEX   0u
#define HID_JOY_REPORT_IN_SIZE    4   // 4 bytes
